  ...
  <Tilt className="xs:w-[250px] w-full">
    ...
    >
      <div
        ...
        className="bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col border border-white/5 transition-shadow duration-300 hover:shadow-card-hover"
      >
        <img
          src={icon}
          alt="web-development"
